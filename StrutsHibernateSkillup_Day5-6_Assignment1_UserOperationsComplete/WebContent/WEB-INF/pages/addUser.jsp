<!--
 JSP page addUser.jsp page displays registration page
...
<script type="text/javaScript">
	//function disableBackButton disables back button
	function disableBackButton() {
		window.history.forward();
	}
	setTimeout("disableBackButton()", 0);
	//function clearFields clears all fields
	function clearFields(event) {
		...
		inputId.placeholder = "User Id";
		inputPassword.placeholder = "Password";
		inputName.placeholder = "Name";
		inputCategory.placeholder = "Category";
		inputSex.placeholder = "Sex";
		inputAddress.placeholder = "Address";
		inputEmailId.placeholder = "EmailId";
		inputId.value = "";
		inputPassword.value = "";
		inputName.value = "";
	...
	//function clearLabales clears labels
	...
	//function validates the user registration form
		...
		<s:if test="#session.loggedInUserType != null">
			<s:if test="#session.loggedInUserType == 'Admin' ">
				<h3 style="color: gold; position: relative; left: 35%; top: 20%">
					<s:text name="global.register"></s:text>
				</h3>
				<s:form action="addUser" name="userRegistrationForm" method="post"
					...
					<div class="inline fields">
						<div class="field">
							<label class="ui olive label" id="userId"><s:text
								...
								placeholder="User ID" name="userDataBean.userId"
								onmouseover="clearLabels(event)" id="searchId">
						</div>
						<div class="field">
							<label class="ui olive label" id="userPassword"><s:text
									name="global.password"></s:text></label> <input type="password"
								placeholder="Password" name="userDataBean.password"
						...
						<div class="field">
							<label class="ui olive label" id="userCategory"><s:text
								...
								class="ui search dropdown" name="userDataBean.category"
								id="searchCategory">
					...
					<div class="inline fields">
						<div class="field" style="position: relative; left: 20px;">
							<label class="ui olive label" id="userSex"><s:text
								...
								class="ui search dropdown" name="userDataBean.sex"
								id="searchSex">
						...
						<div class="field" style="position: relative; left: 130px;">
							<label class="ui olive label" id="userEmailId"><s:text
									name="global.searchemail"></s:text></label> <input type="email"
					...
					<div class="ui">
						<button class="ui inverted primary button" type="submit"
							...
							<s:text name="global.submit"></s:text>
						</button>
