	...
	<div class="content clearfix">
		...
		<s:if test="#session.loggedInUserType != null">
			<s:if test="#session.loggedInUserType == 'Admin' ">
				<h3 style="color: gold; position: relative; left: 20%; top: 20%">Search
					Criteria</h3>
					...
					<div class="inline fields">
						...
						<div class="field">
							<label class="ui olive label" id="userCategory"><s:text
								...
								class="ui search dropdown" id="searchCategory">
								<option value="">---</option>
					...
					<div class="inline fields">
						<div class="field" style="position: relative; left: 20px;">
							<label class="ui olive label" id="userSex"><s:text
								...
								class="ui search dropdown" id="searchSex">
								<option value="">---</option>
		...
		<h3 style="color: gold; position: relative; left: 20%; top: 20%"
		...
		<s:if test="#session.loggedInUserType != null">
			<s:if test="#session.loggedInUserType == 'Admin' ">
				<div class="ui buttons" id="adminControls"
					style="position: relative; left: 59%;">
					...
					<button class="ui blue button" onclick="detailsHref()"
						id="detailsBtn" style="position: relative; left: 40px;">
