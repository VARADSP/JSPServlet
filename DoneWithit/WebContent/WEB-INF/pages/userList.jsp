...
<s:else>
 <s:if test="isDisabled == 'true' ">
   ...
   <input type="checkbox" disabled id="<s:property value="id" />" />
</s:if>
<s:else>
...
<div class="ui buttons" id="adminControls" style="position:relative;left:59%;">
 ...
 <i class="fa fa-plus fa-lg" aria-hidden="true"></i>
   Register</a>
    ...
    <a class="ui violet button" onclick="updateHref()" name="<s:property value="#session.loggedInUser"/>" href="#" id="updateBtn" style="position:relative;left:20px;">
