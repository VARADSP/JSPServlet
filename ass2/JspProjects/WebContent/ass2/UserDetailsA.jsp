...
<html>
<head>
<script type="text/javascript" src="validateass2.js"></script>
<link rel="stylesheet" type="text/css" href="userscss.css">

</head>

<body bgcolor=white>
	<form name="StudentRegistration" action="UserdetailsA" method="post"onsubmit="return(validate(event));">
		...
		<tr>
			...
			<tr>
				...
				<td><input type="text" name="middlename" id="middlename"
					required
						placeholder="Enter middle name initial" size="20" maxlength="1"></td>
			</tr>
