...
/*
 * Class EnableUserAction is used to enable user from the database
 * @author: Varad Parlikar
 * Created Date: 2019/9/09
 */
public class EnableUserAction extends ActionSupport
	...
	/*
	 * method enable enables the user from the database
	 * return type : String
	 */
