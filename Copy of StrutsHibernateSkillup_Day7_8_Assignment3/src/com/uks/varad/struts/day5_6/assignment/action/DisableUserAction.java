...
/*
 * Class DisableUserAction is used to disable user from the database
 * @author: Varad Parlikar
 * Created Date: 2019/9/09
 */
public class DisableUserAction extends ActionSupport
	...
	/*
	 * method disable disables user from the database
	 * return type : String
	 */
	public String disable() {
		...
		isSuccessfull = UserLogic.disableUser(idOfUser);
