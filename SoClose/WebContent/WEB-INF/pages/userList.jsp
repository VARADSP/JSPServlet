...
<s:if test="#session.loggedInUserType == 'Admin' ">
      ...
      <td data-th="Gross">
<s:if test="isDisabled == 'true' ">
    <button class="ui green button" name="<s:property value="id" />" id="enableBtn" onclick="disableUser()" style="position:relative;left:30px;">
        <i class="fa fa-toggle-on fa-lg" aria-hidden="true"></i>
    Enable
    </button>
</s:if>
<s:else>
    <button class="ui red button" name="<s:property value="id" />" id="disableBtn" onclick="enableUser()" style="position:relative;left:30px;">
