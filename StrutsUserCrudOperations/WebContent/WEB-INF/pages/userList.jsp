...
<h3 style="color:gold;position:relative;left:20%;top:20%" id="tableListHeaderId" onmouseover="clearTable()">Table List</h3>
<table id="myTable">
<tbody>
  <tr id='tableHeader'>
...
<s:if test="#session.loggedInUserType != null">
<s:if test="#session.loggedInUserType == 'Admin' ">
<div class="ui buttons" id="adminControls" style="position:relative;left:64%;">
   <a class="ui green button" href="addUser" style="position:relative;left:10px;">
