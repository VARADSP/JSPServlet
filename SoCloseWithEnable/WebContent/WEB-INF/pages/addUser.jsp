...
<s:form action="addUser" name="userRegistrationForm" method="post" onmouseover="clearLabels(event)" cssClass="ui form" style="position:relative;left:35%;">
  <div class="inline fields" >
    <div class="field">
      <label class="ui olive label" id="userId">User ID</label>
      <input type="text" placeholder="User ID" name="userDataBean.userId" onmouseover="clearLabels(event)" id="searchId">
    </div>
    <div class="field">
      <label class="ui olive label" id="userPassword">Password</label>
      <input type="password" placeholder="Password" name="userDataBean.password" onmouseover="clearLabels(event)" id="searchPassword">
    </div>
    <div class="field">
  ...
  <div class="inline fields">
    <div class="field">
      ...
      <input type="text" placeholder="Name" name="userDataBean.name" id="searchName">
    </div>
    <div class="field">
      <label class="ui olive label" id="userAddress">Address</label>
      <input type="text" placeholder="Address" name="userDataBean.address" id="searchAddress">
    </div>
  </div>
  <div class="inline fields">
    ...
    <div class="field" style="position:relative;left:130px;">
      ...
      <input type="email" placeholder="Email" name="userDataBean.emailId" id="searchEmailId">
    </div>
  </div>
 <div class="ui">
   <button class="ui inverted primary button" type="submit" onclick="return validateForm(event);"  style="position:relative;left:20px;">
 <i class="fa fa-plus fa-lg" aria-hidden="true"></i>
   ...
   <s:url var="backURL" action="showUser">
    ...
    <button class="ui inverted red button" onclick="return clearFields(event)" style="position:relative;left:50px;">
