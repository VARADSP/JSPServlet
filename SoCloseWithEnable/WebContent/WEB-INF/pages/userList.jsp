...
function enableUser(){
	...
	var id = document.getElementById('enableBtn').name;
...
function disableUser(){
	...
	var id = document.getElementById('disableBtn').name;
...
<s:if test="#session.loggedInUserType == 'Admin' ">
      ...
      <td data-th="Gross">
<s:if test="isDisabled == 'true' ">
    <button class="ui green button" name="<s:property value="id" />" id="enableBtn" onclick="enableUser()" style="position:relative;left:30px;">
        <i class="fa fa-toggle-on fa-lg" aria-hidden="true"></i>
    Enable
    </button>
</s:if>
<s:else>
    <button class="ui red button" name="<s:property value="id" />" id="disableBtn" onclick="disableUser()" style="position:relative;left:30px;">
...
<div class="ui buttons" id="adminControls" style="position:relative;left:59%;">
 ...
 <i class="fa fa-plus fa-lg" aria-hidden="true"></i>
   Register</a>
    ...
    <a class="ui violet button" onclick="updateHref()" href="#" id="updateBtn" style="position:relative;left:20px;">
        <i class="fa fa-edit fa-lg" aria-hidden="true"></i>
    Update
    </a>

    <a class="ui red button" onclick="deleteHref()" id="deleteBtn" href="#" style="position:relative;left:30px;">
        <i class="fa fa-trash fa-lg" aria-hidden="true"></i>
    Delete
    </a>

    <a class="ui blue button" onclick="detailsHref()" id="detailsBtn" href="#" style="position:relative;left:40px;">
...
<div class="ui buttons" id="userControls" style="position:relative;left:53%;">
    ...
    <a class="ui blue button" onclick="clearTable()" style="position:relative;left:40px;">
        <i class="fa fa-eye fa-lg" aria-hidden="true"></i>
    Details
    </a>
 </div>
