...
<s:if test="#session.loggedInUserType != null">
   <s:text name="global.useraccesstype"></s:text> <s:property value="#session.loggedInUserType"/>

</s:if>
</h3>
<h3 style="float:left;color:gold;position:relative;left:43%;">
   <s:text name="global.welcomelistscreen"></s:text> <br>
...
<i class="fa fa-sign-out fa-lg" aria-hidden="true"></i>
   <s:text name="global.logout"></s:text>
</a>
</div>
...
<div class="ui form" style="position:relative;left:20%;">
  <div class="inline fields">
    <div class="field">
      <label class="ui olive label"><s:text name="global.searchid"></s:text></label>
      <input type="text" placeholder="User ID" id="searchId">
    </div>
    <div class="field">
    <label class="ui olive label"><s:text name="global.searchcategory"></s:text></label>
    <select class="ui search dropdown" id="searchCategory">
      <option value="">---</option>
      <option value="admin"><s:text name="global.searchcategory.admin"></s:text></option>
       <option value="user"><s:text name="global.searchcategory.user"></s:text></option>
    </select>
  </div>
  </div>
  <div class="inline fields">
    <div class="field">
      <label class="ui olive label"><s:text name="global.searchname"></s:text></label>
      <input type="text" placeholder="Name" id="searchName">
    </div>
    <div class="field">
      <label class="ui olive label"><s:text name="global.searchaddress"></s:text></label>
      <input type="text" placeholder="Address" id="searchAddress">
    </div>
  </div>
  <div class="inline fields">
    <div class="field" style="position:relative;left:20px;">
      <label class="ui olive label"><s:text name="global.searchsex"></s:text></label>
     <select class="ui search dropdown" id="searchSex">
      <option value="">---</option>
      <option value="male"><s:text name="global.searchsex.male"></s:text></option>
       <option value="female"><s:text name="global.searchsex.female"></s:text></option>
    </select>
    </div>
    <div class="field" style="position:relative;left:130px;">
      <label class="ui olive label"><s:text name="global.searchemail"></s:text></label>
