...
<h3 style="color:gold;position:relative;left:35%;top:20%">Update User</h3>
<s:form action="addUser" name="userRegistrationForm" method="post" onmouseover="clearLabels(event)" cssClass="ui form" style="position:relative;left:35%;">
  <div class="inline fields" >
    ...
    <div class="field">
      ...
      <input type="password" placeholder="Password" name="userDataBean.password" value="<s:property value="userDataBean.password" />" onmouseover="clearLabels(event)" id="searchPassword">
    </div>
    <div class="field">
