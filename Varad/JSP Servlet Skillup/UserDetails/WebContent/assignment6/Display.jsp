...
<td>
<a type="button" class="button" href="EditUserDetails?uid=${sessionScope.uid }" style="text-decoration: none;float:right; background: green;color:fff;padding: 1em 2em;border: 0;">Edit</a>
</td>
...
<div style=" background-color: #577;padding: 10px;text-align: center;color: white;bottom:0;left:0;position:fixed;width:100%;height:50px;clear:both;">
