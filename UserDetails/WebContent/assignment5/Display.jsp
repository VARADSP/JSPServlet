...
<h3 style="float:left;color:white">Welcome ${sessionScope.username }</h3><h3 style="float:left;color:gold;position:absolute;left:40%;">Successfully Login</h3>
...
<div class="footer" style=" background-color: #577;padding: 10px;text-align: center;color: white;bottom:0;left:0;position:fixed;width:100%;height:50px;">
