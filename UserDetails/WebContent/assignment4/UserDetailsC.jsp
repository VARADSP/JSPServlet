<!--
JSP page UserDetailsC used to save user details using servlet to print submitted data into the
browser
...
<html>
 ...
 <title>User Details</title>
  ...
  <body>
    ...
    <div class="container">
      <!--Creating form-->
    <form name="loginForm" accept-charset="utf-8" action="UserDetailsC" method="post" onSubmit="return validateForm(event);">
      <table cellspacing="5">
        <tr>
