package com.uks.varad.servlet.assignment2;
 ...
 */
@WebServlet("/assignment2/UserDetailsA")
		...
		try {
			...
			if (i > 0) {
				...
				out.println("<h1 align=\"center\" style=\"color:red;\"><b>Can not register the data into the database !</b></h1>");
			  	out.println("<a type=\"button\" class=\"button\" href=\"UserDetailsA.jsp\" style=\"text-decoration: none;position:relative;left:45%; background: coral;padding: 1em 2em;color: #fff;border: 0;margin:20px;text-decoration:none;display:inline-block;\">Go Back</a>");
